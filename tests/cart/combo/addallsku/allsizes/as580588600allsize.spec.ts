...
process.env.ALLURE_RESULTS_DIR = "raw-test-data/cart/combo/580588600/allsizes"
  ...
  test(`Add all Skus of size ${gsize.desc} to cart Qty - ${qty[i]}`, async ({}, testInfo) => {
    ...
    await testInfo.attach(`AS580_588_600_addtocart_${gsize.desc} size_Qty_${qty[i]}.png`, {
