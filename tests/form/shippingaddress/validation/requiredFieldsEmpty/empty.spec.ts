...
process.env.ALLURE_RESULTS_DIR = "raw-test-data/forms/shipadd/validation/emptyfields";
...
for (const device of largeScreen) {
  test(`Shipping Address required fields empty ${device.name} `, async ({}, testInfo) => {
    /**
